...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.6\textwidth]{dens_str_VS.png}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.6\textwidth]{effs_VS.png}
...
Como se observa en la figura \ref{fig:corrT}, las mediciones de \textit{craving} estuvieron correlacionadas antes y después  del tratamiento experimental. Por su parte, la medición de impulsividad no estuvo relacionada con las mediciones de \textit{craving} en la fase basal (Fig \ref{fig:corrA}), pero sí en la fase post-tratamiento (Fig \ref{fig:corrB}).
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.6\textwidth]{gphT1.png}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.6\textwidth]{gphT2.png}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.6\textwidth]{gphT3.png}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.6\textwidth]{graphL11.png}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.6\textwidth]{graphL12.png}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.7\textwidth]{graphL13.png}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.65\textwidth]{graphL21.png}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.65\textwidth]{graphL22.png}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.8\textwidth]{graphL23.png}
...
% Table created by stargazer v.5.2.2 by Marek Hlavac, Harvard University. E-mail: hlavac at fas.harvard.edu
% Date and time: Fri, Sep 20, 2019 - 04:18:40 AM
\begin{table}[!htbp] \centering
